...
import { AnvilIcon, BarChart2, BarChart3, Package, PlaneIcon, Plus, Settings, MessageSquare } from "lucide-react";
...
function LoadingSidebar() {
  const navigation = [
    ...
    { name: " Total Trips", href: "/trips", icon: Package },
    { name: "Add Trips", href: "/addTrip", icon: Plus },
    { name: "Destinations", href: "/destination", icon: PlaneIcon },
    { name: "Settings", href: "/settings", icon: Settings },
    { name: "AI Assistant", href: "/chatgpt", icon: MessageSquare },
    
  ];

  return (
    <div className="fixed left-0 top-0 bg-gray-950 text-white w-64 min-h-screen p-6 z-10">
      <div className="mb-8">
